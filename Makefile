# Project Setup
PROJECT_NAME := configuration-servicehub
PROJECT_REPO := github.com/opusdavei/$(PROJECT_NAME)
...
Crossplane Targets:
	...
	render             Render the example compositions through the function pipeline.
...
.PHONY: submodules uptest e2e render yamllint crossplane.help help-special
